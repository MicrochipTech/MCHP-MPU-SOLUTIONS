...
leRectangleWidget* Screen1_RectangleWidget_5;
leLabelWidget* Screen1_LabelWidget_14;
...
leResult screenShow_Screen1(void)
{
    ...
    Screen1_RectangleWidget_5 = leRectangleWidget_New();
    ...
    Screen1_LabelWidget_14 = leLabelWidget_New();
    Screen1_LabelWidget_14->fn->setPosition(Screen1_LabelWidget_14, 310, 164);
    Screen1_LabelWidget_14->fn->setSize(Screen1_LabelWidget_14, 284, 101);
    Screen1_LabelWidget_14->fn->setVisible(Screen1_LabelWidget_14, LE_FALSE);
    Screen1_LabelWidget_14->fn->setScheme(Screen1_LabelWidget_14, &WhiteScheme);
    Screen1_LabelWidget_14->fn->setBackgroundType(Screen1_LabelWidget_14, LE_WIDGET_BACKGROUND_NONE);
    Screen1_LabelWidget_14->fn->setString(Screen1_LabelWidget_14, (leString*)&string_charged_notice);
    root1->fn->addChild(root1, (leWidget*)Screen1_LabelWidget_14);
...
void screenHide_Screen1(void)
{
    ...
    Screen1_RectangleWidget_5 = NULL;
    Screen1_LabelWidget_14 = NULL;
